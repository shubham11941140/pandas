...
class AbstractHolidayCalendar(metaclass=HolidayCalendarMetaClass):
    ...
    def holidays(self, start=None, end=None, return_name=False):
        ...
        # get them again
        if self._cache is None or start < self._cache[0] or end > self._cache[
                1]:
            pre_holidays = [
...
USMemorialDay = Holiday("Memorial Day",
                        month=5,
                        day=31,
...
USThanksgivingDay = Holiday("Thanksgiving Day",
                            month=11,
                            day=1,
...
USPresidentsDay = Holiday("Washington’s Birthday",
                          month=2,
                          day=1,
                          offset=DateOffset(weekday=MO(3)))
...
def HolidayCalendarFactory(name,
                           base,
                           other,
