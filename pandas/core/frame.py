...
""")
    ...
    def where(
        ...
        return super().where(cond, other, inplace, axis, level, errors,
                             try_cast)
    ...
    def mask(
        ...
        return super().mask(cond, other, inplace, axis, level, errors,
                            try_cast)
