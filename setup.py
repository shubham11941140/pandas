...
_pxi_dep_template = {
    "algos":
    ["_libs/algos_common_helper.pxi.in", "_libs/algos_take_helper.pxi.in"],
    "hashtable": [
...
for name, data in ext_data.items():
    ...
    if (sys.platform == "zos"
            and data.get("language") == "c++" and os.path.basename(
                os.environ.get("CXX", "/bin/xlc++")) in ("xlc", "xlc++")):
